    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
      ...
      <div>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          Calculate your monthly EMI and total repayment for an education loan.
        </p>
      </div>
        ...
        <Card title="Loan Summary">
          {summary.emi > 0 ? (
            <div className="space-y-4">
              ...
              <div className="mt-4 p-3 bg-amber-50 dark:bg-amber-900/20 rounded text-xs text-gray-600 dark:text-gray-400 border border-amber-200 dark:border-amber-800">
                <strong>Note:</strong> Some education loans offer a moratorium period (grace period)
                during your course and a short time after completion. EMI calculations shown here
                assume immediate repayment. Check with your lender for moratorium details.
              </div>
